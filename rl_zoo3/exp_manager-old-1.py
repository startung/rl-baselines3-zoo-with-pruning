...
class ExperimentManager:
    ...
    def __init__(
        ...
        save_freq: int = -1,
        # lth: Optional[Dict[str, Any]] = None,
        # lottery_ticket_hypothesis: Optional[Dict[str, Any]] = None,
        ...
        lottery_ticket_hypothesis: Any = "",
    ):
        super().__init__()
        self.algo = algo
        self.env_name = EnvironmentName(env_id)

        # Lottery Ticket Hypothesis params
        # self.lth = lth
        self.lottery_ticket_hypothesis = lottery_ticket_hypothesis
    ...
    def setup_experiment(self) -> Optional[Tuple[BaseAlgorithm, Dict[str, Any]]]:
        ...
        # Special case for Lottery Ticket Hypothesis
        if self.lottery_ticket_hypothesis is not None:
            self.lottery_ticket_hypothesis = self._preprocess_lottery_ticket_hypothesis()
    ...
    def _preprocess_lottery_ticket_hypothesis(self) -> Optional[Dict[str, Any]]:
        if self.lottery_ticket_hypothesis is not None:
            #     # Overwrite hyperparams if needed
            #     hyperparams.update(self.lottery_ticket_hypothesis)
            print("Lottery Ticket Hypothesis is not supported yet")
            print("Provided Lottery Ticket Hypothesis parameters:" + str(self.lottery_ticket_hypothesis))
        return None
