...
def train() -> None:
    ...
    parser.add_argument(
        ...
        default="",
        # action=StoreDict,
        help="Enable and provide parameters for the lottery ticket hypothesis (e.g. pruning:all pruning_rate:0.2 pruning_type:layerwise)",
    )
    ...
    print(args.lottery_ticket_hypothesis)
    ...
    exp_manager = ExperimentManager(
        ...
        # lottery_ticket_hypothesis=args.lottery_ticket_hypothesis,
    )
